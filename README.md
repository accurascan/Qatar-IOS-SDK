...
extension ViewController: VideoCameraWrapperDelegate{
    ...
    func recognizeSucceed(_ scanedInfo: NSMutableDictionary!, recType: RecType, bRecDone: Bool, bFaceReplace: Bool, bMrzFirst: Bool, photoImage: UIImage, docFrontImage: UIImage!, docbackImage: UIImage!) {
     ...
     func reco_msg(_ messageCode: String!) {
        ...
        messageCode :- ACCURA_ERROR_CODE_MOTION then set message "Keep Document Steady"
        messageCode :- ACCURA_ERROR_CODE_DOCUMENT_IN_FRAME then set message "Keep document in frame"
        messageCode :- ACCURA_ERROR_CODE_BRING_DOCUMENT_IN_FRAME then set message "Bring card near to frame"
		messageCode :- ACCURA_ERROR_CODE_PROCESSING then set message "Processing..."
        messageCode :- ACCURA_ERROR_CODE_BLUR_DOCUMENT then set message "Blur detect in document"
        messageCode :- ACCURA_ERROR_CODE_FACE_BLUR then set message "Blur detected over face"
		messageCode :- ACCURA_ERROR_CODE_GLARE_DOCUMENT then set message "Glare detect in document"
		messageCode :- ACCURA_ERROR_CODE_HOLOGRAM then set message "Hologram Detected"
		messageCode :- ACCURA_ERROR_CODE_DARK_DOCUMENT then set message "Low lighting detected"
		messageCode :- ACCURA_ERROR_CODE_PHOTO_COPY_DOCUMENT then set message "Can not accept Photo Copy Document"
        messageCode :- ACCURA_ERROR_CODE_FACE then set message "Face not detected"
		messageCode :- ACCURA_ERROR_CODE_MRZ then set message "MRZ not detected"
		messageCode :- ACCURA_ERROR_CODE_PASSPORT_MRZ then set message "Passport MRZ not detected"
    }
```
